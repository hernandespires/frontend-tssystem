...
export const FindAllEmployeesProvideer = ({
	children
}: {
	children: ReactNode
}) => {
	const [allEmployeesDataFound, setAllEmployeesDataFound] = useState<
		Employee[]
	>([])
	...
	useEffect(() => {
		const fetchEmployees = async () => {
			setIsLoading(true)
			setError(null)
			setAllEmployeesDataFound(await findAllEmployees())
		}
