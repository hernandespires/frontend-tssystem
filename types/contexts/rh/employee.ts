...
export interface CreateEmployeeContextTypes {
	employeeData: SendEmployee
	setEmployeeData: Dispatch<SetStateAction<SendEmployee>>
}
...
export interface FindAllEmployeesContextTypes {
	...
	setAllEmployeesDataFound: React.Dispatch<React.SetStateAction<Employee[]>>
	isLoading: boolean
	error: string | null
}
