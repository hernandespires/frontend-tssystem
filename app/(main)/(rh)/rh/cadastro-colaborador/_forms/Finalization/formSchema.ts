...
const HIDDEN_DEPARTMENTS = ["FINANCE", "HUMAN_RESOURCES", "MARKETING", "RESEARCH_AND_DEVELOPMENT", "SALES"] as const
...
export const formSchema = z
	...
	.superRefine((data, ctx) => {
		const shouldRequireOperation = !HIDDEN_DEPARTMENTS.includes(data.department as any)
