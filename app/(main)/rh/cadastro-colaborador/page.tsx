        ...
        <>
            {
                ...
                : actualStep === 3 ? <LaborDocuments urlPath={path} prevStep={() => setActualStep(1)} actualStep={actualStep} percentageProgress={40} nextStep={() => setActualStep(3)} /> 
                : actualStep === 1 ? <BankDetails urlPath={path} prevStep={() => setActualStep(2)} actualStep={actualStep} percentageProgress={60} nextStep={() => setActualStep(4)} /> 
